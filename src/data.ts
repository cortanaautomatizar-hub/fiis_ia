...
export const AVAILABLE_FIIS: FiiMetric[] = [
  ...
  { symbol: 'GARE11', name: 'Guardian Real Estate', segment: 'Híbrido', currentPrice: 8.15, fairPrice: 10.12, p_vp: 0.81, dy: 11.0, vacancy: 0, liquidity: 'R$ 1M/dia', lastDividend: 0.075, description: 'FII híbrido com estratégia de renda imobiliária.', dailyChange: 0.0 },
